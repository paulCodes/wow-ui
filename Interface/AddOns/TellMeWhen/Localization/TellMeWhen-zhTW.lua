...
當你準備好編輯你的圖示時請關閉這個視窗。]=]
L["CHANGELOG_LAST_VERSION"] = "以前安裝的版本" -- Needs review
...
請輸入計時器全名到“用於檢查的計時器”。]=]
L["CONDITIONPANEL_BITFLAGS_ALWAYS"] = "總是如此" -- Needs review
L["CONDITIONPANEL_BITFLAGS_CHECK"] = "否定選擇" -- Needs review
...
L["CONDITIONPANEL_BITFLAGS_CHOOSEMENU_TYPES"] = "選擇類型..." -- Needs review
...
L["CONDITIONPANEL_GROUPSIZE"] = "實際大小" -- Needs review
L["CONDITIONPANEL_GROUPSIZE_DESC"] = [=[檢查針對當前的隊伍數量進行實際調整。


這包括當前的彈性團隊組合的調整。]=] -- Needs review
