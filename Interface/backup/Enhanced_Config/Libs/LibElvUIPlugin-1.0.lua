...
local HDR_INFORMATION = "ElvUI Plugins Loaded - (Green - Current , Red - Out of Date)"
local INFO_BY = "by"
...
if GetLocale() == "ruRU" then -- Russian Translations
	...
	HDR_CONFIG = "Плагины"
	HDR_INFORMATION = "ElvUI - загруженные плагины (зеленый означает, что у вас последняя версия, красный - устаревшая)"
	INFO_BY = "от"
	INFO_VERSION = "Версия:"
	INFO_NEW = "Последняя:"
end
...
function lib:RegisterPlugin(name,callback)
	...
	local enabled, loadable = select(4,GetAddOnInfo("Enhanced_Config"))
