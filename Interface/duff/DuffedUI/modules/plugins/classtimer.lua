...
elseif C["unitframes"].layout == 2 then
	...
	if D.myclass == "DRUID" then 
		if C["unitframes"].druidmushroombar then
			playerFrame:Point("BOTTOMLEFT", DuffedUIPlayer, "TOPLEFT", 2, 23)
			playerFrame:Point("BOTTOMRIGHT", DuffedUIPlayer, "TOPRIGHT", -2, 23)
		else
			playerFrame:Point("BOTTOMLEFT", DuffedUIPlayer or DuffedUIWildMushroomBar, "TOPLEFT", 2, 13)
			playerFrame:Point("BOTTOMRIGHT", DuffedUIPlayer or DuffedUIWildMushroomBar, "TOPRIGHT", -2, 13)
		end
	elseif D.myclass == "SHAMAN" then
