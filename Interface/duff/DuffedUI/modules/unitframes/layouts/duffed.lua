...
local function Shared(self, unit)
	...
	if (unit == "player" or unit == "target") then
		...
		if C["unitframes"].charportrait == true then
			...
			if isMac or graphic == "D3D11" then
				pf:Size(45)
				if unit == "player" then
					pf:Point("BOTTOMRIGHT", power, "BOTTOMLEFT", -5, 0)
				else
					pf:Point("BOTTOMLEFT", power, "BOTTOMRIGHT", 5, 0)
				end
	...
	if (unit == "targettarget") then
		...
		if C["unitframes"].charportrait == true then
			...
			if isMac or graphic == "D3D11" then
				pf:Size(21)
				pf:Point("TOPLEFT", health, "TOPRIGHT", 7, 0)
				pf:Point("BOTTOMLEFT", power, "BOTTOMRIGHT", 7, 0)
