...
DuffedUIConfigUILocalization.generaloutlines = "Set outlines for textelements (correct values: THINOUTLINE, OUTLINE)"
...
DuffedUIConfigUILocalization.tooltipitemcompare = "Enable ItemCompare"
